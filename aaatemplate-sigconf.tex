...
El hipervínculo Offender Information en la tabla ~\ref{tab:dataset} vincula la información que se muestra en la figura ~\ref{fig:deathRow}, de la cual se decidió considerar únicamente los atributos mostrados en el cuadro 2 debido a que estos son relevantes para nuestro estudio.
